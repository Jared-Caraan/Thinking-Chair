...
def productExceptSelf(nums):
    ...
    #     old_val = nums[i]
    #     del nums[i]
    #     holder.append(nums.copy())
    #     nums.insert(i, old_val)

    # holder = [reduce(product, i) for i in holder]
    # return holder
